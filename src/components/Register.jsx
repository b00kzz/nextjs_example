...
const Register = () => {
  ...
  console.log("🚀 ~ file: Register.jsx:6 ~ Register ~ formData:", formData)
  ...
  const hadleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("🚀 ~ file: Register.jsx:19 ~ axios.post ~ error:", error)
    }
  }
    ...
    <div className='flex flex-col items-center justify-center'>
      <form onSubmit={hadleSubmit} action='#'>
        <div class="relative z-0 w-full mb-6 group">
          <input onChange={(e) => handleChange(e)} type="text" name="username" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
          <label for="username" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Username</label>
        </div>
        <div class="relative z-0 w-full mb-6 group">
          <input onChange={(e) => handleChange(e)} type="password" name="password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="dropdown dropdown-hover relative z-1 w-full mb-6 group">
          <select
            ...
            <option value={'ชาย'}><a>ชาย</a></option>
            <option value={'หญิง'}><a>หญิง</a></option>
          </select>
        </div>
