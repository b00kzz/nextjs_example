  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <form onSubmit={hadleSubmit} action='#'>
        ...
        <button type="button" onClick={() => window.location.replace("/admin/home")} class="text-white ml-4 bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ยกเลิก</button>
      </form>
    </div>
  )
}
